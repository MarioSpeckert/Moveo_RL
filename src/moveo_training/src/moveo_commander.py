...
class MoveoCommander(object):
    ...
    def set_gripper(self, joint_angle):
        self.gripper_values = self.gripper.get_current_joint_values()
        # ugly implementaion, need to find a better one 
        self.gripper_values = [joint_angle[0],joint_angle[0],-joint_angle[0],joint_angle[0],-joint_angle[0],joint_angle[0]]
        print("grippervalues")
        print(self.gripper_values)
        print("grippervalues")
        self.gripper.set_joint_value_target(self.gripper_values)
    ...
    def execute_trajectory(self):
        ...
        # self.plan_gripper = self.gripper.plan()
        # self.gripper.go(wait=True)
